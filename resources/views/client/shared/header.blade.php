        ...
        <div class="row">
            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                <div class="text-slid-box">
                    <div id="offer-box" class="carouselTicker">
                        <ul class="offer-box">
                            <li>
                                <i class="fab fa-opencart"></i> Giảm giá 10% khi mua 1 Bộ sách
                            </li>
                            <li>
                                <i class="fab fa-opencart"></i>Nhân ngầy 30/4-01/05 giảm giá toàn bộ sản phẩm sách văn học việt nam
                            </li>
                            <li>
                                <i class="fab fa-opencart"></i>Tặng thêm Voucher 500k khi mua đơn hàng 2500k trở lên 
                            </li>
                            <li>
                                <i class="fab fa-opencart"></i>giảm giá 20% khi mua combo 5 sách
                            </li>
                            <li>
            ...
            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                <div class="right-phone-box">
                    <p>Liên hệ: <a href="#"> +(84) 0346791196</a></p>
                </div>
                <div class="our-link">
                    <ul>
                        @if(Auth::check())
    ...
    <nav class="navbar navbar-expand-lg nav-bg navbar-default bootsnav">
        <div class="container-fluid">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="{{ url('/home') }}"><img width="150px" src="{{asset('front_assets/images/3.JPG')}}" class="logo" alt=""></a>
            </div>
            ...
            <div class="attr-nav">
                <ul>
                    ...
                    <li class="side-menu"><a href="{{ url('/cart-page') }}" id="call_cart_js">
